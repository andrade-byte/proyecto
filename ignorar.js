// let edad = parseInt(prompt("Qué bueno que sepas la clave, pero, ¿qué edad tenés?"));

// while (Number.isNaN(edad) || edad <18) {
//   edad = parseInt(prompt("O tu edad es un Nan o sos menor. Decime una edad válida."));
// }
...
// if (edad >= 1 8 && tienePlata) {
//   bienvenida ();
// } else {
//   despedida ();
// }

// console.table("De todos modos, te quería mostrar también un índice de toda la gente que ha intentado entrar, de su edad y de su situación financiera por si tenías la duda:");
...
// console.table("Esto quiere decir que:");
